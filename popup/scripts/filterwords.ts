const input = document.querySelector('.filter-words input') as HTMLInputElement;
const filterWordsList = document.querySelector('.filter-words-list') as HTMLUListElement;
...
async function renderFilterWords() {
    ...
    filterWords.forEach(function (word: string) {
